...
<style>
    ...
    .flip-card.found .flip-card-back::after {
        ...
        background-color: hsla(from var(--color-primary-dark-2) h s l / 0.4);
        position: absolute;
        width: 100%;
        height: 100%;
        top: 0;
    ...
    .flip-card-front {
        ...
        @media screen and (min-width: 481px) and (max-width: 800px), screen and (min-height: 551px) and (max-height: 750px) {
